    ...
    <div class="max-w-xl mx-auto mt-10 p-6 bg-white rounded shadow">
        ...
        <form action="{{ route('clientes.update', $cliente->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="nif" id="nif" value="{{ old('nif', $cliente->nif) }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>
            ...
            <div>
                ...
                <textarea name="endereco" id="endereco" rows="3"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('endereco', $cliente->endereco) }}</textarea>
            </div>
            <div>
