...
@section('content')
    <div class="max-w-7xl mx-auto py-6">
        <div class="bg-white p-6 rounded shadow">
            <h2 class="text-2xl font-bold mb-4">Lista de Faturas Recibos Emitidas</h2>
                            ...
                            @foreach ($faturas as $fatura)
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-2 border text-center">
                                        <a href="{{route('faturas.faturarecibo.detalhe',$fatura->id)}}" class="text-blue-600 hover:underline">Ver detalhes</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
