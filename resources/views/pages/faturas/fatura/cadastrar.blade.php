...
@section('content')
    <div class="max-w-5xl mx-auto py-6">
        <div class="bg-white p-6 rounded shadow">
            <h2 class="text-2xl font-bold mb-4">Emitir Nova Fatura</h2>
            ...
            <form method="POST" action="{{ route('faturas.fatura.store') }}">
                @csrf
                ...
                <button type="button" id="add-item" class="bg-blue-600 text-white px-4 py-2 rounded">+ Adicionar
                    Item</button>
