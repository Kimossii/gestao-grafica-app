        ...
        <form action="{{ route('produtos.update', $produto->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="descricao" id="descricao" rows="3"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('descricao', $produto->descricao) }}</textarea>
            </div>
            <div>
            ...
            <div>
                <label for="prazo_producao" class="block text-sm font-medium text-gray-700">Prazo Produção (dias)</label>
                <input type="number" step="0.01" name="prazo_producao" id="prazo_producao" value="{{ old('prazo_producao', $produto->prazo_producao) }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>
            <div>
                <label for="preco_base" class="block text-sm font-medium text-gray-700">Preço Base <span class="text-red-500">*</span></label>
                <input type="number" step="0.01" name="preco_base" id="preco_base" value="{{ old('preco_base', $produto->preco_base) }}"
                    required
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>
            ...
            <div>
                ...
                <input type="number" step="0.01" name="largura" id="largura" value="{{ old('largura', $produto->largura) }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>

            <div>
                <label for="altura" class="block text-sm font-medium text-gray-700">Altura (cm)</label>
                <input type="number" step="0.01" name="altura" id="altura" value="{{ old('altura', $produto->altura) }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>
            ...
            <div>
                ...
                <input type="number" step="0.01" name="prezo_producao" id="prezo_producao"
                    value="{{ old('prezo_producao', $produto->prezo_producao) }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>

            <div>
                <label for="tipo_papel" class="block text-sm font-medium text-gray-700">Tipo de Papel</label>
                <input type="text" name="tipo_papel" id="tipo_papel" value="{{ old('tipo_papel', $produto->tipo_papel) }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>

            <div>
                <label for="gramatura" class="block text-sm font-medium text-gray-700">Gramatura</label>
                <input type="number" name="gramatura" id="gramatura" value="{{ old('gramatura', $produto->gramatura) }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>

            <div>
                <label for="cores" class="block text-sm font-medium text-gray-700">Cores</label>
                <input type="text" name="cores" id="cores" value="{{ old('cores', $produto->cores) }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>

            <div>
                <label for="acabamento" class="block text-sm font-medium text-gray-700">Acabamento</label>
                <input type="text" name="acabamento" id="acabamento" value="{{ old('acabamento', $produto->acabamento) }}"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            </div>
            ...
            <div>
                ...
                @if($produto->image)
                    <div class="mt-2">
                        <img src="{{ asset( $produto->image) }}" alt="Imagem atual" class="h-24">
                    </div>
                @endif
            </div>
